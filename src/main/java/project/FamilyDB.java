...
public class FamilyDB {
 ...
 public	void createDB() throws ClassNotFoundException{
	      ...
	      try
	      {
	       ...
	       statement.executeUpdate("CREATE TABLE NameTable (id INTEGER PRIMARY KEY AUTOINCREMENT, FirstName STRING,SurName STRING , DOB STRING, DOD STRING, Profession STRING ,fuid INTEGER)");  // gender,DOB,DOD,adrees 
